...
app_name = 'proveedor' # asegurarme que exista el namespace 
urlpatterns = [
    ...
    path('<int:proveedor_id>', views.detail, name="detail"), #* llego con esta base http://127.0.0.1:8000/productos/producto_id
]
